...
class WebhookOutboundHandlerRuleCondition(models.Model):
    _name = "bwt.webhook.outbound.handler.rule.condition"
    ...
    source_kind = fields.Selection(
        selection=OUTBOUND_RULE_SOURCE_SELECTION,
        required=True,
        default="delivery_field",
    )
    source_expression = fields.Char(required=True, string="Source Key")
    operator = fields.Selection(
        selection=OUTBOUND_RULE_CONDITION_OPERATOR_SELECTION,
        required=True,
        default="equals",
    )
